...
class t29Messages {
	...
	public static $msg = array(
		...
		'footer-copyright-tag'   => '&copy; 2003-2016 technikum29.',
		'footer-legal-link'      => array('Impressum und Kontakt', 'Legal notices'),
		'footer-legal-file'      => array('/impressum.php', '/contact.php'),
		'footer-legacy-text'     => array('&copy; 2003-2016 technikum29. Alle Bilder und Fotografien sind kopierrechtlich geschützt, siehe <a href="/de/impressum.php" class="go">Impressum</a>',
		                                  '&copy; 2003-2016 technikum29. You must not use contents and photographies without the permission of the owner. <a href="/en/contact.php" class="go">Legal Information</a>.'),
