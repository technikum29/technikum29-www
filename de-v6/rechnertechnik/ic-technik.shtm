...
<head><!--#set var="title"        value="Programmierbare Rechner der 3. Generation mit einfacher IC-Technik"
   --><!--#set var="location"     value="ic-technik"
   --><!--#set var="part"         value="rechnertechnik"
   --><!--#set var="url_en"       value="computer/ic-technology.shtm"
   --><!--#set var="prev"         value="programmierbare.shtm"
   --><!--#set var="prev_title"   value="Programmierbare Rechner der 2. Generation"
   --><!--#set var="next"         value="lochkarten-edv.shtm"
   --><!--#set var="next_title"   value="Lochkartengeräte"
 --><title>Technikum29 - <!--#echo var="title" --></title>

    <!--#include virtual="/de/inc/head.inc.shtm" -->
    <meta name="keywords" content="Wang 700, Erste Rechner der 3. Generation mit einfacher IC-Technik" />
...
<div id="content">
    <h2><!--#echo var="title" --></h2>
      ...
      <a class="go" href="/de/details1.shtm" name="backlink-details1" title="Details 1">siehe tabellarische Darstellung der Tischrechner</a></p>
<h3>WANG 700</h3>
      <div class="box center auto-bildbreite">
          <a href="/de/geraete/wang700.shtm" name="backlink-wang700" title="Zur Großaufnahme des WANG 700"><img src="/shared/photos/rechnertechnik/wang700-anlage.jpg" alt="WANG 700" width="600" height="438" /></a>
          <p class="bildtext">Komplettanlage<b> WANG 700</b></p></div>
            ...
            Links befindet sich der Rechner mit einem zweizeiligen gro&szlig;en Nixier&ouml;hren-Display, 2 kB Kernspeicher und eingebautem Kassettentape zur Programmaufzeichnung. Dieser Rechner war für Jahre der schnellste Tischrechner der Welt.
               <a class="go" href="/de/geraete/wang700.shtm">Großaufnahme des Rechners betrachten</a>
...
Mit dem angeschlossenen Markierungskartenleser (anstelle ausgestanzter Löcher werden Felder per Hand geschwärzt) war der Rechner auch für Schulen und Universitäten ideal nutzbar. Offline konnten beliebig viele Anwender Programme auf Karten makieren und dann mit einem einzigen Rechner testen.<br>
