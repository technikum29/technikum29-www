...
?>
    ...
    <p>
	   Deutschland war 1923 nach den USA (1921) und Großbritannien (1922) das dritte Land in dem der Rundfunk eingeführt wurde. Technisch wäre man dazu schon ca. 1920 in der Lage gewesen.<br>
	...
	<div class="box center auto-bildbreite">
        <img src="/shared/photos/kommunikationstechnik/seibt-edr16.jpg" width="600" height="383" alt="Seibt Dektektorempfänger EDR 16" />
        <p class="bildtext">
	        <b>Seibt EDR 16</b></p>
	</div>
	<p>	Detektorempfänger erhalten ihre Energie, die man nur mit einem Kopfhöhrer wahrnehmen kann, ausschließlich aus dem Empfangssignal einer großen Antenne. Man musste mit einer Metallspitze auf einem Kristall "herumstochern" um mit viel Glück einen starken Sender hören zu können. Der "Detektor" bestand aus einem kleinen Bleiglanz- oder Pyritkristall (ca.5mm) und zeigte an manchen Stellen einen Dioden-Effekt, der die Demodulation des Hochfrequenzsignales bewirkte. Solche Geräte waren die preiswerte Alternative zu den teueren Rundfunkgeräten. Rechts im Bild befindet sich ein typisches Buch aus dieser Zeit.
		</p>
	
		 
	<p>Es ist erstaunlich, welch geringe Zeitspanne zwischen der sehr bescheidenen Einf&uuml;hrung des Rundfunks und dessen Perfektion liegt. Wie die Pilze wuchsen die neugegründeten Firmen in den Himmel und die Zahl der Hörer stieg täglich an. Am Anfang hatten die Ger&auml;te noch ein technisches Design, genau wie heute, doch ab den drei&szlig;iger Jahren wandelte sich das Radioger&auml;t zu teils attraktiven M&ouml;belst&uuml;cken. F&uuml;r beides sind Beispiele aus dem Museumsbestand abgebildet.</p>
...
Das folgende Gerät konnte man schon an den Haushaltsstrom anschließen. Damit entfiel der lästige Batteriekauf und das Laden der Akkumulatoren.</p><br>
    ...
    <div class="box center auto-bildbreite">
        <img src="/shared/photos/kommunikationstechnik/huth.jpg" width="600" height="385" alt="Fotografie des HUTH-Empf&auml;ngers" />
    ...
    <div class="box left clear-after">
        <a href="/de-v6/geraete/telefunken_t40w.php"><img src="/shared/photos/kommunikationstechnik/telefunken_t40w/klein.jpg" alt="Fotografie des Telefunken T40W" class="nomargin-bottom" /></a>
        <p class="bildtext">Klicken Sie einfach auf das Bild und schon öffnet sich die Welt der Technik in ihrer ästhetischsten Form. <a href="/de-v6/geraete/telefunken_t40w.php" class="go">die Extraseite "Telefunken T 40W"</a></p>
    </div>

    <p>Die n&auml;chsten Bilder zeigen beispielhaft Ger&auml;te, die sich optisch und auch von der Technik her hervorheben. Jedoch lie&szlig;e sich diese Bildergalerie beliebig weiterf&uuml;hren.
       <br/>Im Museum sind viele weitere Rarit&auml;ten zu bewundern, ein H&ouml;rerlebnis ist aus jeder Epoche  m&ouml;glich: Detektorger&auml;te, Batterieempf&auml;nger (20er J.), Luxus-Super (30er J.), fr&uuml;he Musikschr&auml;nke (1932) sowie quasi als Ende einer Etappe der erste Nachkriegsempf&auml;nger mit Motor-Sendersuchlauf und Kabelfernbedienung: SABA Freiburg 3D (Bj. 1954), ein Meilenstein mit 5 eingebauten Lautsprechern, der so beeindruckend im Klang ist, dass selbst CD-verw&ouml;hnte Kids staunend vor dem &uuml;ber 50 Jahre altem Ger&auml;t stehen. Insgesamt wird einsichtig, wie Rundfunk vor zwei bis drei Generationen erlebt wurde und wie schnell sich die Entwicklung vollzogen hat.</p>
...
Gegenüber dem mageren Klang eines Grammophons waren hiermit jedoch schon Musikkonserven in akzeptabler Qualität abspielbar.<br>
    ...
    <div class="box center auto-bildbreite">
        ...
        <p class="bildtext"><b>Körting Ultramar</b>, das größte, aufwendigste und teuerste Gerät des Jahres 1935. 11 Röhren, zwei Lautsprecher und eine enorme Empfangsleistung zeichneten es aus.
            ...
            <br/>Auf Wunsch können Sie das <a class="go" name="backlink-ultramar" href="/de-v6/geraete/ultramar_hinten.php">Innenleben des Ultramars sowie die Skala</a> erforschen.
        </p>
    </div>
