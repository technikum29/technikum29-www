<?php
	$seiten_id = 'sonstiges';
	$version = '$Id$';
	$titel = 'Pianola, Kinomaschine und Anderes';
	
	require "../lib/technikum29.php";
?>
    <h2>Pianola, Kinomaschine und Anderes</h2><br>

	<h3 id="pianola">Pianola</h3>
	...
	<div class="box desc-left borderless">
		...
		<div class="Bildtext center">Drei Lochkarten mit Text:
	...
	<div class="box desc-right borderless">
        <img src="/shared/photos/start/leander.jpg" alt="Leander Schwarzer" width="313" height="239" class="nomargin-bottom" />
		<p class="Bildtext small">Leander Schwarzer im <b>technikum29</b> beim Stanzen von Lochkarten an einer IBM Maschine</p>
	</div>
	...
	<div class="box desc-right borderless">
		...
		<p class="Bildtext small center">Lochkarten durchlaufen eine "Spieluhr"</p>
	</div>
