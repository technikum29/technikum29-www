...
<b>8.1.2014:</b> Der 2. Fehler (6.1.) war relativ schnell gefunden: Im 2. Speichermodul fehlte ein "Headconnector" der entsprechende Verbindungen von den Boards zum Kernspeichermodul herstellt. Vollkommen unklar, wie so ein Teil verschwinden kann.<br>
	...
	Vergrößern: Bild anklicken!</p></div>
		...
		<b>29.1.2017:</b> Mittlerweile ist es uns auch gelungen, die Lochstreifengeräte am der 1130 zum Laufen zu bringen. Wir können z.B. das ASCII-Bild "SNOOPY" über Lochstreifen laden und ausdrucken lassen. Zusätzlich sind wir in der Lage, Klartext, also beliebigen lesbaren Text, auf Lochstreifen zu stanzen. Das kombinierte Fortran/Assembler-Programm hierfür umfasst 392 Lochkarten.<br>
		Nun fehlt nur noch die Anbindung des Plotters an den Rechner.<br>
