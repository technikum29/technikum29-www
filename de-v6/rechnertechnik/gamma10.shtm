...
<head><!--#set var="title"        value="EDV-Anlage der 2. Generation: BULL GAMMA 10"
   --><!--#set var="location"     value="gamma10"
   --><!--#set var="part"         value="rechnertechnik"
   --><!--#set var="url_en"       value="computer/gamma10.shtm"
...
<div class="box center manuelle-bildbreite" style="width: 650px;">
	    <img src="/shared/photos/rechnertechnik/gamma10,offen.jpg" alt="BULL GAMMA 10 ohne Verkleidung" width="650" height="564" /></div>
	<div class="box center manuelle-bildbreite" style="width: 650px;">
	    <img src="/shared/photos/rechnertechnik/gamma10,rueckseite.jpg" alt="BULL GAMMA 10 ohne Verkleidung" width="650" height="633" />
    ...
    <div class="box left clear-after">
		<img src="/shared/photos/rechnertechnik/steuerpult.jpg" alt="Ausschnitt des Programmierer-Steuerpults" width="485" height="379" />
		<p class="bildtext">
