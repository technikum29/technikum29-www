...
<div id="content">
    ...
    <div class="box center auto-bildbreite">
        ...
        <p class="bildtext">
			...
			in the <a href="/en/devices/univac9400/highspeed-printer.shtm">high
			speed printer</a> of the <a href="univac9400.shtm">UNIVAC mainframe</a>
   ...
   <h3><a name="lochband">Two channel punched tape</a></h3>
   <div class="box left clear-after">
       ...
       <p class="bildtext">
           As already described before (section <a class="go" href="programmable.shtm">programmable 2nd generation desktop calculators</a>), the DIEHL Combitron calculator used a time delay memory (like the magnetostrictive memory described elsewhere). Since this type of memory is volatile, DIEHL needed a non-volatile memory for the overall control of the machine. This had been implemented using a two channel punched tape. The first channel serves as a clock channel while the second channel contains the actual control data.
