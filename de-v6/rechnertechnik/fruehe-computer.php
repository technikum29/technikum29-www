...
<head><!--#set var="title"        value="Wissenschaftliche Rechner und Minicomputer"
   --><!--#set var="location"     value="fruehe-computer"
   --><!--#set var="part"         value="rechnertechnik"
   --><!--#set var="url_en"       value="computer/early-computers.shtm"
   --><!--#set var="prev"         value="kommerzielle.shtm"
   --><!--#set var="prev_title"   value="Fr&uuml;he kommerzielle Rechner"
   --><!--#set var="next"         value="analogrechner.shtm"
   --><!--#set var="next_title"   value="Analog- und Hybridrechner"
 --><title>technikum29 - <!--#echo var="title" --></title>

    <!--#include virtual="/de/inc/head.inc.shtm" -->
    <meta name="keywords" lang="de" content="PDP-8, PDP-8L, PDP-8I, Classic-8, PDP-12, LAB-12, LAB-8, Lochstreifentechnik, Lochkartentechnik, Fr&uuml;he Computer" />
...
<div id="content">
	...
	<div class="box left clear-after">
		...
		<p class="bildtext small">Externe Speicher des LGP-21 sind Lochstreifen, welche durch die Tally-Lochstreifenleser noch mechanisch abtastet werden. Das Bandlaufwerk und weitere externe Platten mit je ca. 8000 32-Bit-Worte Kapazität kamen erst Ende der 60er Jahre hinzu.</p></div>
	...
	<!--<div style="margin-left: 400px; min-width: 490px">    -->
		<!--<div class="box left" style="clear:left;">
			
				<p class="small">
					Links: <b>PDP-8</b> mit Magnetband-Einheit TU 580,
					Lochstreifenleser und Festplatte, rechts: Bedienungspannel.
				</p>
		</div>-->
<p>PDP-Rechner wurden vorwiegend von Wissenschaftlern eingesetzt, z.B. bei fast allen Max-Planck-Forschungsinstituten. Mit Hilfe selbstgebauter Interface-Karten bestand die Möglichkeit, bereits vorhandene Geräte und experimentelle Anordnungen einzubinden. Selbst dazu lieferte DEC vorgefertigte Boards, die einen Selbstbau von Anpassungen sehr erleichterten. Die Abbildung oben zeigt links ein typisches Modul der 2. Generation (1965) ohne ICs aus der Classic PDP-8. In der Mitte befindet sich ein kleines Modul der 3. Generation (ab 1967) mit ICs, welches in den Geräten PDP-8/I, PDP-8/L und PDP-12 verwendet wurde. Rechts schließlich ist ein leeres Modul; es kann vom Anwender für spezifische Erweiterungen der Peripherie bestückt werden. </p>
	...
	<p>Eines der musealen Highlights ist die PDP-8 Komplettanlage, bestehend aus Prozessor, Bandlaufwerk TU 580 (gehörte ursprünglich zur PDP-5, Bj. 1963), Lochstreifenleser/stanzer PC 01, Festplatte DF 32 mit unbeweglichen Köpfen und dem Teletype Fernschreiber als Drucker. Diese Classic-8 ist der erste in Serie gebauter "Minicomputer" der Welt (Bj. 1965, Serien Nr. 100). <br/>
		...
		Der Prozessor und der Lochstreifenleser sind Leihgaben des <a href="http://www.fitg.de">"FITG",  Frankfurt </a></small>
	...
	<h3>PDP-8/I</h3>
    <div class="box left">
	   <!--<div style="float:left; margin: 0 2em 0 0;" class="auto-bildbreite">   -->
...
oder als helle Aufnahme: <a  class="popup" href="/shared/photos/rechnertechnik/dec/konsole,hell.jpg">PDP-12 Konsole (Hellaufnahme)</a>
	...
	<p> Unser Rechner war durch den Einbau folgender Optionen sehr komfortabel nutzbar (in den runden Klammern steht die Zahl der dazu notwendigen Module):<br>
...
<a  class="popup" href="/shared/photos/rechnertechnik/nova-detail.jpg">NOVA 2 mit Terminal</a><br>
	...
	<h3><b>WANG 2200</b> mit umfangreicher Peripherie</h3>
