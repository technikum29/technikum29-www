...
<head><!--#set var="title"        value="Didaktische Konzeption, Informationen für Lehrer"
   --><!--#set var="location"     value="lehrerinfo"
   --><!--#set var="url_en"       value="no-translation.shtm?how=no&amp;backurl=lehrerinfo&amp;backtitle=Lehrerinfo"
   --><!--#set var="prev"         value="index.shtml"
   --><!--#set var="prev_title"   value="Startseite"
   --><!--#set var="next"         value="kommunikationstechnik/rundfunk.shtm"
   --><!--#set var="next_title"   value="Rundfunk"
   -->
    ...
    <style type="text/css">
    <!--
        /* ehemalig in extra.css als .highlight { } */
        em {
            color: #000E8C;
            font-style: italic;
        }
    ...
    <meta name="t29.this.version" content="v5.7.18" />
	<meta name="t29.date" content="18.02.2008 22:17" />
	<meta name="t29.comment" content="Viel neuer Inhalt, Erhebung zur 'völligen' Inhaltsseite" />
</head>
<body>
...
<h2><!--#echo var="title" --></h2>
	...
	<p>
		Prinzipiell bieten wir Führungen mit den Themenbereichen "<b>Computer History</b>" oder "<b>Kommunikationstechnik</b>" an. Diese eignen sich für technisch interessierte Gruppen und Menschen, die einfach nur neugierig sind und sich in der Kulturgeschichte der intelligentesten und wichtigsten Werkzeuge, wie Computer und Kommunikationstechniken, weiter bilden möchten. Sie müssen sich zwischen diesen Themen entscheiden, da beide Gebiete in einer Führung mental überfordern würden und zeitlich nicht realisierbar sind.
   <br><br>

		
		Für interessierte Schülergruppen (Mindestalter ca. 14 Jahre) wird eine pädagogisch ausgewogene und altersgemäße Führung angeboten:</p>

<ul>
	<li><b>1.</b> Sie wählen nur die Führung (ca. 90 Minuten: Interessant, locker und informativ).</li><br>
...
<p>Unser hochgestecktes Ziel ist, Schüler für Technik zu interessieren. Dies ist anhand "begreifbarer" historischer Technik als Einstieg durchaus möglich. Insbesondere im Bereich "Computer" ist eine Anbindung von neuer an alte Technik machbar und führt schnell auf sehr interessante Themen (siehe "Entwicklungsprojekte").</p>


<p>  
Die Einbindung von Schülern durch eigene Referate vor Ort ist prinzipiell auch möglich, wird aber ehr selten gewünscht.
Materialien hierzu finden Sie gegebenenfalls in der Rubrik "Projekte". Sie können diese mit Hilfe eines Passwortes abrufen. Das Passwort erhalten Sie nach Rücksprache.</p><br><br>


<p><span style="color:red"><b>PILOTPROJEKT:</b></span><br>
	<a href="/de/lernprojekte/pilotprojekt.pdf">Wir möchten testen, ob auch schon interessierte Schüler der 4. Klasse (Grundschule) mit Spaß und Erfolg an einem "Workshop" teilnehmen können. Lesen Sie bei Interesse weiter (diesen Text anklicken).</a>
	</p><br>
	
<p class="small">
Hier Meinungen von Schülern (anonym abgegeben), die mit ihrem Kurs das technikum29 besucht und an der Rallye teilgenommen haben:<br><br>
...
<!--<div class="box bordered" style="width:75%;margin-left:auto;margin-right:auto;">-->
