<?php
	...
	$version = '$Id$';
	$titel = 'Rechner der 2. Generation';
...
<div class="box center">
	...
	<p>Wir haben in unserer Sammlung einige Geräte: RAE 4/15-2, RAE 4/30-1, -2 und -3, die wir nach und nach reparieren werden. Über den Fortschritt in der Reparatur unserer Olympia RAE-Tischrechner werden wir im <a class="go" href="/de/geraete/Olympia_rae/RAE_4-details.php">Olympia RAE-Reparaturblog</a> berichten.</p>
	...
	Lesen Sie dazu den <a class="go" name="backlink-wanderer" href="/de/geraete/wanderer.php">Originalprospekt</a>.</p><br>
