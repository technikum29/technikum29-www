...
<head><!--#set var="title"        value="Telegraphie-, Fax- und Schreibtechnik"
   --><!--#set var="location"     value="faxtechnik"
   --><!--#set var="part"         value="kommunikationstechnik"
   --><!--#set var="url_en"       value="communication/fax.shtm"
   --><!--#set var="prev"         value="tontechnik.shtm"
   --><!--#set var="prev_title"   value="Tonaufnahme- und Wiedergabetechnik"
   --><!--#set var="next"         value="messtechnik.shtm"
   --><!--#set var="next_title"   value="Mess- und Experimentaltechnik"
...
<div id="content">
    ...
    <div class="box left clear-after">
        <a href="/de/geraete/morsetelegraf.shtm" name="backlink-morsetelegraf"><img src="/shared/photos/kommunikationstechnik/telegrafie-regal.jpg" alt="Das Telegrafie-Regal" width="240" height="464" /></a>
        <div class="bildtext">
    ...
    <div class="box center">
        ...
        <div class="cols">
            <div class="leftcol">
                <p>Der <b>Fultograph</b> ist ein von dem Engländer Otho Fulton 1929 entwickelter <b>"Bildfunkempfänger"</b>. Im Gegensatz zu dem Bildtelegraphen, der über Leitungen kommunizierte, konnte der Bildfunkempfänger über Sender, die gerade erst für den Rundfunk entwickelt wurden, betrieben werden. 
...
<h2>Fernschreibtechnik</h2>
    ...
    <p>Der ratternde Fernschreiber bestimmte Jahrzehnte das Bild der schnellen Nachrichtenübermittlung. 1930 erstmals von Siemens & Halske vorgestellt, wurde er am 16. Oktober 1933 von der Deutschen Reichspost eingeführt. Die erste amtliche Verbindung bestand zwischen Berlin und Hamburg. Für das Fernschreib- Telexnetz mussten separate Leitungen verlegt werden. <br/>
	    Von 21 Teilnehmern 1933 stieg die Zahl auf 1500 im Jahre 1939 und schließlich auf über 90.000 um 1975. Der mechanische Fernschreiber wurde nun auf elektronische umgestellt (Telex). Diese sichere und stabile Nachrichtenübermittlung findet sogar heute noch in einigen Entwicklungsländern Anwendung.</p>
