...
?>
	...
	Vergrößern: Bild anklicken!</p></div>
		...
		Weitere Tests haben ergeben: Der Speicher-Test läuft korrekt, für den CPU-Test müssen wir erst noch den erforderlichen "Basic-Diagnostic-Loader" (Lochkarten) besorgen.
