<?php
	...
	$version = '$Id$';
	$titel = 'BULL Tabelliermaschine';
	
	require "../../lib/technikum29.php";
?>
    <h2>BULL Tabelliermaschine</h2>
    ...
    <p>
	   ...
	   <div class="box center auto-bildbreite">
        ...
        <p class="bildtext"><i>Bild 1: Tabelliermaschine Bull BS-PR</i> </p>
	</div>
	   
    <p>Die hier abgebildete Tabelliermaschine BULL BS-PR wurde im Oktober 1956 gebaut. Der Kaufpreis betrug damals ca. 260.000,- DM  (130.000. Euro), eine horrende Summe, wenn man bedenkt, dass 1956 ein durchschnittliches KFZ für deutlich unter 3000,- DM zu haben war. Dennoch kamen große Betriebe und insbesondere Banken nicht umhin Lochkartenmaschinen anzuschaffen um rationell arbeiten zu können.</p>
	
	<div class="box left">
        <img src="/shared/photos/rechnertechnik/bull-bs-pr/relais1.jpg" alt="Teilansicht der Relais der geöffneten Bull-Tabelliermaschine" width="312" height="416"><p class="bildtext"><i>Bild 2 zeigt drei Rechenwerke und ca. 700 der 1500 Relais</i></p>
       </div>
	   
	 <p> Von außen ist es ein unscheinbarer Blechkasten aber von innen ein Meisterwerk an elektromechanischer Technik. Vorne (Bild 1) stehen zwei auswechselbare Schalttafeln, die jeweils an der linken Seite (hier unsichtbar) angedockt werden. Die linke Tafel beinhaltet ein Programm zur Berechnung und zum Drucken von Kontoauszügen, rechts ist ein einfaches Multiplikationsprogramm gesteckt.</br>
 

	  Multiplikationen und Divisionen benötigen ein Mehrfaches an Zeit als einfache Saldierungen. Um diese Zeit drastisch zu verkürzen, konnte man den "Elektronenrechner" <a href="/de/rechnertechnik/gamma3.php">BULL GAMMA 3</a> anschließen. </p>
	
	
    <p>Tabelliermaschinen konnten durch das Auswechseln einer Schalttafel sehr unterschiedliche kombinierte Schreib- und Rechenarbeiten ausführen.<br>
       ...
       <br>Unsere Tabelliermaschine kann z.B. Kontoauszüge berechnen und drucken und beherrscht die 4 Grundrechenarten.<br>
		...
		<p class="bildtext"><i>Bild 3: Rechenwerk der Tabelliermaschine</i></p> 
		</div>
