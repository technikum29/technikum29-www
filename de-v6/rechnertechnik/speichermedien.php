...
<head><!--#set var="title"        value="Historische (interne) Speichermedien"
   --><!--#set var="location"     value="speichermedien"
   --><!--#set var="part"         value="rechnertechnik"
   --><!--#set var="url_en"       value="computer/storage-media.shtm"
   --><!--#set var="prev"         value="analogrechner.shtm"
   --><!--#set var="prev_title"   value="Analog- und Hybridrechner"
   --><!--#set var="next"         value="/de/sonstiges.shtm"
   --><!--#set var="next_title"   value="Pianola und Anderes"
 --><title>technikum29 - <!--#echo var="title" --></title>

    <!--#include virtual="/de/inc/head.inc.shtm" -->
    <meta name="keywords" content="Laufzeitspeicher, Kernspeicher, Festwertspeicher, Stäbchenspeicher, Magnetdrahtspeicher, Lochband" />
...
<h3>Laufzeitspeicher: Magnetostriktion</h3>
 ...
 <h3><a name="kernspeicher">Kernspeicher</a></h3>
   ...
   <div class="box center auto-bildbreite">
      ...
      <h3><a name="staebchenspeicher">Gefädeltes ROM, Festwertspeicher</a></h3>
	  
   <div class="box center auto-bildbreite">
        <a name="backlink-gefaedeltes-rom" href="/de/geraete/gefaedeltes-rom.shtm"><img src="/shared/photos/rechnertechnik/speichermedien/nixdorf-rom-gesamt.jpg" alt="Gefädeltes ROM von Nixdorf" width="694" height="470" /></a>
   ...
   <h3><a name="staebchenspeicher">Stäbchenspeicher</a></h3>
   
   <div class="box center auto-bildbreite">
        <a name="backlink-staebchenspeicher" href="/de/geraete/staebchenspeicher.shtm"><img src="/shared/photos/rechnertechnik/speichermedien/gefaedeltes-rom.jpg" alt="Stäbchenspeicher von Nixdorf" width="692" height="379" /></a>
        <p class="bildtext"><b>Nixdorf Stäbchenspeicher</b></p></div>
			...
			<p><a class="go" href="/de/geraete/staebchenspeicher.shtm">Detailaufnahme betrachten</a></p>
		
   
<h3><a name="magnetdrahtspeicher">Magnetdrahtspeicher</a></h3>

   <div class="box left clear-after">
        <a href="/de/geraete/magnetdrahtspeicher.shtm"><img src="/shared/photos/rechnertechnik/speichermedien/magnetdrahtspeicher.jpg" alt="Beschriftetes Photo: Aufbau des Magnetdrahtspeichers" width="340" height="303" /></a>
	    <p class="bildtext"><b>Univac Magnetdrahtspeicher</b></p>
            ...
            <p>Interessante Einzelheiten sind hier zu lesen: <a class="go" href="/de/geraete/magnetdrahtspeicher.shtm">Aufbau und Funktion des Magnetdrahtspeichers</a></p></div>
	
   
<h3><a name="lochband">Lochband</a></h3>
