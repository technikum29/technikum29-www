<?php
	...
	$version = '$Id$';
	$titel = 'Programmierbare Rechner der 2. Generation';
	
	require "../../lib/technikum29.php";
?>
    <h2>Beispiele für programmierbare Rechner der 2. Generation</h2>
	
    <p>Rechner der 2. Generation hatten noch keine integrierte Schaltkreise. Das erschwerte den Bau leistungsf&auml;higer Rechner erheblich. Daher sind programmierbare Rechner dieser Spezies technisch besonders interessant. Schon 1966 brachte die deutsche Firma DIEHL einen solchen Rechner auf den Markt. Das Betriebsprogramm wird &uuml;ber einen Metall-Lochstreifen "gebootet" (siehe "Speichermedien"), Anwenderprogramme auf Papier-Lochstreifen gestanzt, die wieder eingelesen werden k&ouml;nnen. Wahrlich die Steinzeit programmierbarer Rechner! Solche Komplett-Anlagen sind sehr rar.</p>
	
<h3>Diehl Combitron</h3><br>

<p>Der Diehl-Combitron war der erste funktionsfähige programmierbare Tischrechner, der in Deutschland gebaut und vertrieben wurde (1966-68).
Die ersten Combitron-Maschinen waren ohne Schnittstelle. Man hatte damit keine Möglichkeit, selbst geschriebene Programme zu speichern. Ein Programm konnte jedoch mit einem Zahlencode ausgedruckt werden, den man bei jedem "Neustart" über die Tastatur wieder eingeben musste. 

<div class="desc-left borderless no-copyright">
<a class="popup" href="/shared/photos/rechnertechnik/diehl-els.jpg">
        <img src="/shared/photos/rechnertechnik/diehl-els.jpg" alt="Diehl Lochstreifenstanzer" width="325" height="177" /></a>
	<p class="small"><b>Manueller Lochstreifenstanzer "DIEHL ELS"</b><br>
...
Dieses Verfahren war sehr umständlich und zeitraubend.
		Der Konkurrent "Olivetti" war hier viel fortschrittlicher. <br>
		Dem Druck der Anwender folgend baute man schließlich einen manuellen Lochstreifenstanzer (Diehl ELS), der sozusagen offline betrieben wurde. Es ist das preiswerte Gegenstück zu den Lochkartenstanzern.  </p>
		
	
	<div class="desc-left borderless no-copyright">
	<a class="popup" href="/shared/photos/rechnertechnik/diehl-els-detail.jpg">
        <img src="/shared/photos/rechnertechnik/diehl-els-detail.jpg" alt="Diehl Lochstreifenstanzer" width="325" height="242" />
		</a>
		<p class="small"><b>DIEHL ELS Lochstreifenstanzer Ausschnitt</b><br>
		Vergrößern: Bild anklicken!</p>
		 </div>

<br><br>
		
		Das Detail-Bild zeigt, wie Befehle und Ziffern in den Lochcode umzusetzen waren. Immerhin konnte man damit "just in time" arbeiten.
		Um mit dem Konkurrenten Olivetti mithalten zu können wurde als letzte Version der Lochstreifenstanzer ELS 830, der zunächst nur für den fabrikinternen Gebrauch gedacht war, auch an Kunden verkauft. Dieser Stanzer stanzt die Lochstreifen bei der Eingabe des Programms auf der Tastaur mit. Der Übersetzungscode ist damit entbehrlich.
...
<h3 id="101">Olivetti Programma 101</h3>
    ...
    <div class="desc-left borderless">
       ...
       <p class="small">Die legendäre <b>PROGRAMMA 101</b> von Olivetti. </p>
	   </div>
...
<p class="center"><b>HP 9100A und HP 9100B mit Drucker HP 9120</b></p>
	...
	<p>1968 brachte der erste Tischrechner von HP die Wissenschaftler zum staunen. Er ist ohne ICs aufgebaut und beherrscht alle wesentlichen 
		wissenschaftlichen Funktionen. Als interner Speicher dient ein Kernspeicher, bei dem auch nach dem Abschalten Programme und Daten 
		nicht verloren gehen. Als externer Speicher werden Magnetkarten (kleiner als die von Olivetti) verwendet. Der aufgesetzte Drucker 
		war optional. Als Anzeigemedium dient eine Oszilloskopröhre, mit welcher der Inhalt von 3 Registern abgebildet wird. Die 
		Zeichengenerierung wird von einem gefädelten ROM übernommen. </p>
		
	<div class="box center">
   <a  href="/shared/photos/rechnertechnik/hp9100-display.jpg" class="popup">
      <img src="/shared/photos/rechnertechnik/hp9100-display.jpg" width="375">
   </a>
    <a  href="/de/geraete/hp9100/hp9100_Bilder/hp9100B_print_gr.jpeg" class="popup">
      <img src="/de/geraete/hp9100/hp9100_Bilder/hp9100B_print_kl.jpeg" width="300
      " ">
   </a>

  </div>
  <p class="center"><b>HP 9100 Bildröhrendisplay (li.), Ausdruck auf 9120 (re.)</b></p>

		
		
	<p>Mit diesem relativ kompakten Rechner hat HP Maßstäbe gesetzt. Billig war ein solcher Rechner nicht: Er kostete anfangs 23.000,- DM  (etwa 12.000 Euro) und war daher für Privatpersonen praktisch 
		unerschwinglich. <br/>
