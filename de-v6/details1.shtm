...
<head><!--#set var="title"        value="Besonders interessante Tischrechner und Kleinanlagen aus dem Museumsbestand"
   --><!--#set var="location"     value="details1"
   --><!--#set var="part"         value="extra"
   --><!--#set var="url_en"       value="details1.shtm"
   --><!--#set var="title_en"     value="Tabular list of desk calculators"
   --><!--#set var="prev"         value="/de/rechnertechnik/transistoren.shtm"
   --><!--#set var="prev_title"   value="Erste Rechner mit Tranistoren"
   --><!--#set var="prev2"        value="/de/rechnertechnik/programmierbare.shtm"
   --><!--#set var="prev2_title"  value="Programmierbare Rechner der 2. Generation"
   --><!--#set var="prev3"        value="/de/rechnertechnik/ic-technik.shtm"
   --><!--#set var="prev3_title"  value="Erste Rechner der 3. Generation mit einfacher IC-Technik"
   --><!--#set var="next"         value=""
   ...
   --><title>technikum29 - <!--#echo var="title" --></title>
    ...
    <meta name="t29.version" content="v5.8" />
</head>
<body>
