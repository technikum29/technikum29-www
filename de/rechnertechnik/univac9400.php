<?php
	...
	$version = '$Id$';
	$titel = 'UNIVAC 9400-Großrechner, Rechenzentrum';
...
<ul>
  <li>Prozessor</li>
  <li>Konsole</li>
  <li>Tape-Control-Unit</li>
  <li>UNISERVO 12</li>
  <li>UNISERVO 16</li>
  <li>UNISERVO 12</li>
  <li>Disk-Control-Unit</li>
  <li>Schnelldrucker Typ 768</li>
  <li>2 Plattenlaufwerke Typ 8425</li>
  <li>Lochkartenleser</li>
</ul>
...
<br />Dennoch zeigten sich schon nach relativ kurzer Zeit, dass der Speicher nicht halten konnte, was man versprach: Häufige Defekte machten ihn zum Problemfall. Daher wurde der Speicher unserer 9400 Anlage ca. 1971/72 auf den ersten DRAM Halbleiterspeicher (P1103) von INTEL umgerüstet. Nicht weniger als 1200 Speicher-IC´s der ersten Generation waren notwendig, um die für damalige Zeiten gigantisch große Speicherkapazität von 256 kB zu realisieren. Ein Glück für uns, denn defekte Magnetdrahtspeicher sind größtenteils nicht mehr reparabel.
...
<p>&nbsp;</p> 
 ...
 <div class="box desc-right borderless">
        <img src="/shared/photos/rechnertechnik/kids-an-lochkartenl..jpg" width="467" height="373" alt="Besucher am Lochkartenleser" />
        <p class="bildtext">Junge Besucher sind von der enormen Geschwindigkeit des Lochkartenlesers beeindruckt.</p>
 </div>
