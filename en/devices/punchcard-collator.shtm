...
<head><!--#set var="title"        value="The function of the punch card collator"
   ...
   --><!--#set var="url_de"       value="geraete/lochkartenmischer-funktion.shtm"
   --><!--#set var="title_de"     value="Die Funktion des Lochkartenmischers"
   --><!--#set var="prev"         value="/en/computer/punchcard.shtm#Collators"
   --><!--#set var="prev_title"   value="Punch card computing: IBM 77"
   --><!--#set var="next"         value=""
