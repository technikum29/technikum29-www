...
<head><!--#set var="title"        value="Pianola, Kinomaschine und Anderes"
   --><!--#set var="location"     value="sonstiges"
   --><!--#set var="url_en"       value="miscellaneous.shtm"
   --><!--#set var="prev"         value="rechnertechnik/speichermedien.shtm"
   --><!--#set var="prev_title"   value="Speichermedien"
   --><!--#set var="next"         value="entwicklungsprojekte.shtm"
   --><!--#set var="next_title"   value="Entwicklungsprojekte"
   -->
...
<div id="content">
	...
	<div class="box center">
        <img src="/shared/photos/kommunikationstechnik/pianola.jpg" alt="Abbildung der Pianola" width="700" height="618" class="nomargin-bottom" />
		<p class="center"><b>Pianola</b></p>
	</div>
	
	
		<h3 id="leander">Kunst im Museum</h3>
	
	<p>Das technikum29 animiert zu Tätigkeiten, welche mit Preisen ausgezeichnet werden. Wie das?<br>
	Ein junger Künstler, Leander A. Schwarzer, verzaubert teils alltägliche Gegenstände zu Kunstwerken. So hat der studierte Künstler Bilder aus zusammengenähten Reißverschlüssen entwickelt, die man durch Öffnen oder Schließen von einzelnen Reißverschlüssen selbst beeinflussen kann.<br>
	Der Besuch von Leander A. Schwarzer im technikum29 hat ihn zu neuen Ideen animiert: Lochkarten, heute reine Nostalgie, waren einst Daten- und Programmträger für Maschinen und Computer. Sie beeinflussten die Industrialisierung maßgebend.<br>
	Zunächst entstand das "Terzett", 3 Lochkarten mit den irreversibel eingestanzten Texten:<br>
	
	<div class="box left">
        <img src="/shared/photos/start/lk.jpg"  width="250" height="350" class="nomargin-bottom" />
		<p class="Bildtext small">Bild1: 3 Lochkarten mit Text</p></div>
	...
	<div class="box right">
		...
		<p class="Bildtext small">Bild2: Leander Schwarzer im <b>technikum29</b> beim Stanzen von Lochkarten an einer IBM Maschine</p>
		
		</div>
	<p>Diese Karten wurden im Abstand von ca. 1-2cm vor eine Wand gehängt. Die Sonnenstrahlen warfen Schatten des ausgestanzten und codierten Textes unabänderlich auf die Wand. Das Werk wurde mit einem Preis beim 32. Österreichischem Grafikwettbewerb ausgezeichnet (Innsbruck, 2011).<br>
	...
	<div class="box left">
		...
		<p class="Bildtext small">Bild3: Lochkarten durchlaufen eine "Spieluhr"</p>
		</div>
