...
<head><!--#set var="title"        value="BULL Tabelliermaschine"
   --><!--#set var="location"     value="tabelliermaschine"
   --><!--#set var="part"         value="rechnertechnik"
   --><!--#set var="url_en"       value="computer/tabulating-machine.shtm"
   --><!--#set var="prev"         value="lochkarten-edv.shtm"
   --><!--#set var="prev_title"   value="Lochkartengeräte"
   --><!--#set var="next"         value="gamma3.shtm"
   --><!--#set var="next_title"   value="BULL GAMMA 3"
 --><title>Technikum29 - <!--#echo var="title" --></title>

    <!--#include virtual="/de/inc/head.inc.shtm" -->
    <meta name="keywords" content="Tabelliermaschine, Lochkarten-EDV, ..." />
...
<div id="content">
    ...
    <div class="box center auto-bildbreite">
        ...
        <p class="bildtext"><b>Druckmechanismus</b> der Tabelliermaschine</p></div>
