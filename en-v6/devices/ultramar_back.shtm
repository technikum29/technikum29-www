...
<div class="box center">
	...
	<div class="bildtext">
        <p>This radio features 9 circles, archieving an hundredfold sensitivity from a radio with only one oscillating circuit, "Alloptik"-scale with light projection, display for sensivity, field intensity and bandwith. At that time such a technical indulgence was unknown. That is why this device was called a "&Uuml;bersuper" ("more than super"). Right at the bottom in the image two RE&nbsp;604 tubes are shown, above two commutator tubes RGN&nbsp;1064. The other tubes are from the A-seria.
        <br>The powerinput of 145 watt was remarkable, just like the selling price: An Ultramar costed 640 Reichsmark.</p>
		
		<p>The illustration below shows the elaborate scale where the cursor is implemented by a small light beam.</p>
	</div><!--bildtext-->
</div>
