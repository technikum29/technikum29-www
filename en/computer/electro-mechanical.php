...
?>
	...
	<div class="box left clear-after">
    	<img src="/shared/photos/rechnertechnik/efzet.jpg" width="447" height="433" alt="EFZET Slide Rod Calculator" />
		<p class="bildtext">
			...
			from "Produx". This handy device <i>Efzet</i> was intended
    	</p>
...
<div class="box left clear-after">
   ...
   <p>
    ...
    <div class="box right clear-after">
        ...
        <p class="bildtext"><b>MADAS</b>, an electromechanical calculator from 1927
		...
		bell (at the upper left) that rings after the calculation has finished.</p>
    </div>

    <div class="box left clear-after">
        <img src="/shared/photos/rechnertechnik/rheinmetall.jpg" width="600" height="499" alt="Rheinmetall Superautomat" />
        <p class="bildtext">In 1932, <b>Rheinmetall</b> extended an adding machine with
	...
	<div class="box right clear-after">
        <img src="/shared/photos/rechnertechnik/curta.jpg" width="500" height="489" alt="Curta I and Curta II" />
	    <p class="bildtext">
		    <b>Curta I and Curta II</b>
			<br>These outstanding small pocket calculators were produced almost 
			...
			era on the picture.
			<br>The Internet is full of literature about the Curta, e.g. the
			<a href="http://www.vcalc.net/cu-bckup.htm">story about inventor Curt
			Herzstark</a>.
		</p>
    </div>
	...
	<div class="box right clear-after">
        ...
        <p class="bildtext"><b>DIEHL VSR-18</b>, one of many mechanical calculators
        built between 1955 and 1965.
        <br/>The engineers were hardly pressed to design better and better machines, until
