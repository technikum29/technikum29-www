...
float Dauer = 200;       // Dauer fuer einen Ton in ms, Start mit 200ms
...
void loop() {
  ...
  tone(8, frequenz);
  delay(Dauer);
  //Dauer=Dauer-0.4;        // Vorsicht! "Dauer" kann negativ werden. Daher besser: 
  Dauer=Dauer*0.996;        // 0.996: Kein Komma verwenden!
