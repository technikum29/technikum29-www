...
<head><!--#set var="title"        value="Tonaufnahme- und Wiedergabetechnik"
   --><!--#set var="location"     value="tontechnik"
   --><!--#set var="part"         value="kommunikationstechnik"
   --><!--#set var="url_en"       value="communication/sound_technology.shtm"
   --><!--#set var="prev"         value="rundfunk.shtm"
   --><!--#set var="prev_title"   value="Rundfunk"
   --><!--#set var="next"         value="fernsehen.shtm"
   --><!--#set var="next_title"   value="Fernsehen"
