...
<div class="box center manuelle-bildbreite" style="max-width: 860px">
   ...
   <p class="small"><b>Magnetostriktion: Wissenschaftlich experimentieren</b><br>
		...
		Vergrößern: Bild anklicken!</p></div>
		   ...
		   <br/>Durch Magnetostriktion (kurzes Zusammen-ziehen eines Drahtes, wenn ihn ein starkes Magnetfeld umgibt) werden quasi Schallimpulse auf einen (zusammengerollten) Draht gegeben. Diese Information l&auml;uft mit der Schallgeschwindigkeit (des Materials) bis zum Ende und wird dort wieder in Stromimpulse umgewandelt. Jetzt w&auml;re die Information verloren, wenn man sie nicht aufbereiten und wieder am Anfang des Drahtes eingeben w&uuml;rde.</p>
