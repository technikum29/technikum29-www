...
<head><!--#set var="title"        value="Die Funktion des Lochkartenmischers"
   ...
   --><!--#set var="prev_title"   value="Lochkartengeräte: IBM 77"
   --><!--#set var="next"         value=""
