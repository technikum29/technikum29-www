...
<head><!--#set var="title"        value="PDP 8 linker Fl&uuml;gel"
   ...
   --><title>technikum29 - <!--#echo var="title" --></title>
    ...
    <meta name="t29.this.comment" content="Das wird wohl auch nirgends mehr verlinkt: Das BIld funktionier*te* nicht. Jetzt schon" />
</head>
<body>
