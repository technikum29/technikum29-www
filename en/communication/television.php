...
?>
    ...
    <div class="box left clear-after">
        ...
        <div class="bildtext" style="padding-top: 147px;">Extract from the television room</div>
    </div>

    <p>In 1952, television was a sensation and only affordable by paying several
	   ...
	   in its early time. You can also see the former East Germany's <!-- GDR -->
	   first television (round picture tube), "colored television" (by using a
	   foil) and projection systems from the early fifties.
	</p>

    <div class="box left clear-after">
        <img src="/shared/photos/kommunikationstechnik/saba.schauinsland.jpg" alt="Saba Schauinsland WII" width="420" height="310" />
        <p class="bildtext">
		    One of the first television recievers from the postwar period is
			the <b>Saba Schauinsland WII</b>. In 1954 people crowded together
    ...
    <div class="box left clear-after">
        <a href="/en/devices/saba-telerama.php" name="backlink-telerama" title="Erläuterung und Bild der Telerama-Projektion anschauen"><img src="/shared/photos/kommunikationstechnik/saba_telerama.jpg" alt="Saba Telerama" width="360" height="466" /></a>
        <div class="bildtext">
            <b>Saba Telerama</b>
    ...
    <div class="box left clear-after">
        <img src="/shared/photos/kommunikationstechnik/sony_kp5010.jpg" alt="Fotografie vom Sony KP 5010" width="360" height="466" />
        <div class="bildtext">
		    <b>Sony KP 5010</b>
            <p>This is the world's first rear projection color television set. It was built in the early 1970s and does not yet use ICs but transistors (second generation).</p>
            <!-- 2 Grundfarben kommt nicht, weil die englischen Besucher nicht das technikum29 besuchen werden -->
        </div>
	</div>

    <div class="box left clear-after">
        <img src="/shared/photos/kommunikationstechnik/telefunken.tp1005.jpg" alt="Fotografie des Telefunken Bildplattenspielers TP1005" width="360" height="236" />
        <p class="bildtext">Furthermore we demonstrate executable heavy video recorders with 1- or as well 2-inch tapes (Ampex, Grundig, Philips) and players for optical videodisks which are quite awesome. In 1975 the Telefunken optical videodisc player <b>TP 1005</b> (picture on the right) came on the market. A mechanically driven micro-diamond scanned the optical videodisks. Unfortunately the system did not get recognition any more because the disks stores only ten minutes of video.</p>
    </div>
