...
<div id="content">
    ...
    <div class="box left clear-after">
      ...
      <!--
        Blabla-Gelaber (Blindzitat von
        http://www.computerwoche.de/heftarchiv/1981/27/1186613/
        Pierre Letrot in "Arts et Manufactures") soll spaeter mal uebersetzt
        werden.
      -->
      <p>
        ...
        <br/>Summing up, the calculator features almost 400 electron tubes.
    ...
    <div class="box center auto-bildbreite">
        <img src="/shared/photos/rechnertechnik/bull-gamma3.jpg"
             alt="BULL GAMMA 3 Innen" width="692" height="565" />
	    <p class="bildtext"><b>Tubes over Tubes: BULL Gamma 3</b></p>
	</div>
	...
	<p>
        ...
        case. On the left you can see a part of the big power supply &ndash;
        39 fuses keep the electric circuits seperated for additional security.

        <br/>When this calculator is connected to our BULL Tabulating Machine,
    ...
    <div class="box left clear-after">
      <img src="/shared/photos/rechnertechnik/gamma-3-netzteil.jpg"
        alt="BULL GAMMA 3 power supply" width="350" height="527" />
      <p class="bildtext">
        ...
        calculators looked like! <!-- stupid-mode... -->
        <br/>At these days, selenium rectifier were used to convert AC to DC.
        They are made from stacks of square <!-- thanks, en.wikipedia.org -->
        plated with about 1&micro;m of bismuth or nickel. A much thicker layer of selenium
        ...
        <!-- Source: http://en.wikipedia.org/wiki/Selenium_rectifier
             Creative Commons SA license... and a blind quote here... -->
