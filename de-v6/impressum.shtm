...
<head><!--#set var="title"        value="Impressum"
   --><!--#set var="location"     value="impressum"
   --><!--#set var="url_en"       value="contact.shtm"
   --><!--#set var="prev"         value="suche.shtm"
   --><!--#set var="prev_title"   value="Das Museum sucht..."
   --><!--#set var="next"         value=""
