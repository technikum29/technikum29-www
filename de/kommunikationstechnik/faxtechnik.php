<?php
	...
	$version = '$Id$';
	$titel = 'Telegraphie-, Fax- und Schreibtechnik';
	
	require "../../lib/technikum29.php";
?>
    <h2>Telegraphie, Faximile und Fernschreibtechnik</h2>
    ...
    <div class="box left clear-after">
        ...
        <div class="bildtext">
		    ...
		    <p>Das Bedürfnis der Menschen über weite Entfernungen Informationen auszu-tauschen ist sehr alt.  Hier wurde der Name MORSE zum Synonym für die Telegraphie schlechthin. Um 1838 entstanden die ersten Verkehrstelegraphen.</p>
            <div class="center">
	            <img src="/shared/photos/kommunikationstechnik/morseschreiber.jpg" alt="Morseschreiber (1876)" style="float:none;"/>
		    </div>
		    <p>Bereits im dem Büchlein "Der technische Telegraphendienst" aus dem Jahre 1876 ist ein Morsetelegraph als Federzeichnung abgebildet. Unten wird ein Nachfolgemodell (Eisenbahntelegraph, um 1900) aufgeführt. Das bestechende an dieser Technik ist die verblüffende Einfachheit der Funktion.
		    <br/>Wenn Sie den schönen Telegraphen im Holzkasten von S.A. HASLER (Bern) größer sehen möchten, klicken Sie einfach auf das Bild.</p>
		</div>
    </div>
	...
	<div class="box right" id="telegraf-zu">
        <img src="/shared/photos/kommunikationstechnik/telegrafenstation-halboffen.jpg" alt="Telegrafenstation halboffen" class="nomargin-bottom" width="341" height="201" onclick="switchGeraet('telegraf');" />
        <div class="bildtext">Was steckt in dieser Holzkiste? Öffnen Sie den Deckel und staunen Sie.</div>
        <div class="clear">&nbsp;</div>
    </div>
    ...
    <div class="box center" id="telegraf-offen">
        ...
        <div class="bildtext">
            <h3>TELEGRAPH von S.-A. HASLER, Bern</h3>
            <p>Über Einzelheiten berichten wir demnächst.</p>
        </div>
    </div>
	-->

    <div class="box center auto-bildbreite">
        <img src="/shared/photos/kommunikationstechnik/morsetelegraph-um1900.jpg" width="439" height="249" alt="Fotografie eines Morsetelegraphes um 1900" />
        <p class="bildtext">Dieser Telegraph stammt aus der Zeit um 1900. Kommunikation per Kabel lief vor über 100 Jahren noch sehr gemächlich. Die Zeiten waren ruhig und Hektik kein Thema.</p>
    </div>
...
<div id="t32" class="box left">
	  <a href="/shared/photos/kommunikationstechnik/siemens-t32.jpg"><img src="/shared/photos/kommunikationstechnik/siemens-t32.jpg" width="435" height="415"/></a>
		<p class="bildtext">
		 ...
		 <p>Der ratternde Fernschreiber bestimmte Jahrzehnte das Bild der schnellen Nachrichtenübermittlung. 1930 erstmals von Siemens & Halske vorgestellt, wurde er am 16. Oktober 1933 von der Deutschen Reichspost eingeführt. Die erste amtliche Verbindung bestand zwischen Berlin und Hamburg. Für das Fernschreib- Telexnetz mussten separate Leitungen verlegt werden. <br/>
	    Von 21 Teilnehmern 1933 stieg die Zahl auf 1500 im Jahre 1939 und schließlich auf über 90.000 um 1975. Der mechanische Fernschreiber wurde nun auf elektronische umgestellt (Telex). <br>

Die Blütenzeit der Mechanik in der Nachrichtentechnik bestand u.a. in den verschiedenen Fernschreibertypen. Der relativ seltene Springschreiber T32 wurde ab den 30er Jahren bis in die 50er hergestellt. Es ist ein Streifenschreiber mit überschaubarem Aufwand aber ungeheuer stabil aufgebaut. Im Buch von F. Schiweck "Fernschreibtechnik" (1942) wird hervorgehoben:</p>

		<blockquote>"Der Fernschreiber ist heute eins der hervorragendsten Erzeugnisse der Feinwerktechnik, indem er in sich höchste Kunst der Getriebetechnik, Werkstoffbehandlung und Herstellung vereinigt. Seine Betriebssicherheit ist nach dem Urteil der Praxis außerordentlich groß".</blockquote>
		
		<p>In diesem voll mechanisiertem Zeitalter benötigten die "Büromaschinenmechaniker" ein gefühlvolles Händchen, gute Ohren um eventuelle Störgeräusche einordnen zu können und jede Menge Ölkännchen mit verschiedenen Ölsorten. In den 80er Jahren ist dieser Beruf schließlich ausgestorben.</p>
	...
	<div class="box center auto-bildbreite">
		<img src="/shared/photos/kommunikationstechnik/fernschreiber.jpg" width="520" height="536" alt="Fernschreiber" />		
		<p class="bildtext">
